...
class ProfileUpdateView(UpdateView):
    ...
    def get_initial(self):
        ...
        initial_data['academic_level'] = self.object.profile.academic_level
        initial_data['country'] = self.object.profile.location.city.state.country
        initial_data['state'] = self.object.profile.location.city.state
        initial_data['city'] = self.object.profile.location.city
    ...
    def form_valid(self, form):
        ...
        if Profile.objects.filter(user=self.object):
            ...
            profile.academic_level = form.cleaned_data['academic_level']
            profile.save()
